...
import BackgroundImage from '../assets/images/BG_for_main.jpg'
                  ...
                  <div className="card mb-4" key={key} >
                    ...
                    <ul id="imageList" className="list-group list-group-flush">
                      <li className="list-group-item">
                        <p class="text-center">
							{/* < PDFReader url={`https://ipfs.infura.io/ipfs/${image.hash}`} /> */}
              ...
              { this.props.docs.map((doc, key) => {
                return(
                  <div className="card mb-4" key={key} >
                    ...
                    <ul id="imageList" className="list-group list-group-flush">
                      <li className="list-group-item">
                        <p class="text-center"><a href={`https://ipfs.infura.io/ipfs/${doc.hash}`} target="_blank" download>Click to Download Document</a>
                        </p>
                        <p>{doc.description}</p>
                      </li>
                    </ul>
