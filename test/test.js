const TumblrCloneDapp = artifacts.require('./TumblrCloneDapp.sol')

require('chai')
  .use(require('chai-as-promised'))
  .should()

contract('TumblrCloneDapp', ([deployer, author, tipper]) => {
  let app

  before(async () => {
    app = await TumblrCloneDapp.deployed()
  })
  ...
  describe('deployment', async () => {
    ...
    it('has a name', async () => {
      ...
      assert.equal(name, 'TumblrCloneDapp')
    })
  })
